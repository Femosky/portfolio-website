        ...
        <div className="mx-auto max-w-[45rem] px-6 pb-24 pt-16 md:px-6 md:pb-36 md:pt-20">
            ...
            <main className="flex flex-col gap-16 md:gap-24">
                ...
                <section className="col-reverse flex flex-col gap-2 md:flex-row md:gap-9">
                    <h2 className="w-36 shrink-0 font-medium text-primary-hover">About</h2>
                    <div className="flex flex-col gap-6 font-normal text-primary">
                        <p>
                            ...
                            <span onClick={redirectToPortfolio} className="inline-flex">
                                <Button variant="hollow" className="px-2 py-1 shrink-0 text-xs flex gap-1 items-center">
                ...
                <section className="col-reverse flex flex-col gap-2 md:flex-row md:gap-9">
                    <h2 className="w-36 shrink-0 font-medium text-primary-hover">Work</h2>
                ...
                <section className="col-reverse flex flex-col gap-2 md:flex-row md:gap-9 mb-20">
                    <h2 className="w-36 shrink-0 font-medium text-primary-hover">Education</h2>
